  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Visited Schools */}
        <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden no-break">
                ...
                {(displayedVisited || []).map((school, index) => {
                  ...
                  return (
                    <tr
                      ...
                      className={`cursor-pointer transition-colors ${isSelected ? "bg-blue-100 hover:bg-blue-200" : "hover:bg-blue-50"
                        }`}
                    >
